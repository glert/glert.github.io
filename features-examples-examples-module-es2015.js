...
class ExamplesComponent {
    ...
    ngOnInit() {
        this.isAuthenticated$ = this.store.pipe(Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["select"])(_core_core_module__WEBPACK_IMPORTED_MODULE_2__["selectAuthUser"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(user => user != null));
    }
}
